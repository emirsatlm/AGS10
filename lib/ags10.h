...
#define AGS10MA_I2C_DEFAULT_ADDR   0x1A
 ...
 * 
 * @param p_sensor A handle to indicate sensor ID.
...
bool ags10_tvoc_get(AGS10MA_HandleTypeDef* p_sensor,
                    uint32_t* p_tvoc);

bool ags10_address_set(AGS10MA_HandleTypeDef* p_sensor,
                       uint8_t new_addr);
